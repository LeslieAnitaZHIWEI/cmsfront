    ...
    <iv-row>
      <iv-col :xs="24" :sm="24" :md="24" :lg="17">
        <div class="layout-left">
          ...
          <article-page-footer :article="article" :postId="article.id"></article-page-footer>
          <article-phone-footer></article-phone-footer>
        </div>
      </iv-col>
...
import ArticlePhoneFooter from '@/components/views/Article/ArticlePhoneFooter'
...
export default {
  ...
  components: {
    ...
    'article-phone-footer': ArticlePhoneFooter,
      ...
      this.$http({
        ...
        if (data && data.code === 200) {
          ...
          this.$nextTick(function () {
            ...
            document.title = this.article.title + ' | 果子体育'
          })
        }
      })
    },
